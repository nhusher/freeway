...
document.write('<script>if (typeof goog != "undefined") { goog.require("freeway.core"); } else { console.warn("ClojureScript could not load :main, did you forget to specify :asset-path?"); };</script>');