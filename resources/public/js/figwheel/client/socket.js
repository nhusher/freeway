...
}catch (e25803){if((e25803 instanceof Error)){
var e = e25803;
return null;
} else {
throw e25803;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__25804){
...
var retry_count = cljs.core.get.call(null,map__25807__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__25807__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__25807__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__25807__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4423__auto__,map__25807,map__25807__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
var and__16849__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__16849__auto__){
var and__16849__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__16849__auto____$1)){
var and__16849__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
});})(url,socket,WebSocket,temp__4423__auto__,map__25807,map__25807__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4423__auto__,map__25807,map__25807__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4423__auto__,map__25807,map__25807__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__16861__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4423__auto__,map__25807,map__25807__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4423__auto__,map__25807,map__25807__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__17199__auto__ = (10000);
var y__17200__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__4423__auto__,map__25807,map__25807__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
