...
var m__17517__auto__ = (sablono.util.to_str[goog.typeOf(x__17516__auto__)]);
if(!((m__17517__auto__ == null))){
return m__17517__auto__.call(null,x);
} else {
var m__17517__auto____$1 = (sablono.util.to_str["_"]);
...
var x__17516__auto__ = (((x == null))?null:x);
var m__17517__auto__ = (sablono.util.to_uri[goog.typeOf(x__17516__auto__)]);
if(!((m__17517__auto__ == null))){
return m__17517__auto__.call(null,x);
} else {
var m__17517__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__17517__auto____$1 == null))){
return m__17517__auto____$1.call(null,x);
} else {
...
var len__17919__auto___19076 = arguments.length;
var i__17920__auto___19077 = (0);
while(true){
if((i__17920__auto___19077 < len__17919__auto___19076)){
args__17926__auto__.push((arguments[i__17920__auto___19077]));

var G__19078 = (i__17920__auto___19077 + (1));
i__17920__auto___19077 = G__19078;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__17927__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq19075){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19075));
});
/**
...
var vec__19080 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__19080,(0),null);
var words = cljs.core.nthnext.call(null,vec__19080,(1));
...
var G__19082 = clojure.set.rename_keys.call(null,m,kmap);
var G__19082__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__19082,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__19082);
return G__19082__$1;
} else {
return m;
}
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__19083_SHARP_){
if(typeof p1__19083_SHARP_ === 'string'){
return p1__19083_SHARP_;
} else {
return cljs.core.seq.call(null,p1__19083_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__16861__auto__ = x__$1.hasDomain();
