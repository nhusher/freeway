...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__19086_SHARP_){
return ((p1__19086_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__19086_SHARP_ === 'string');
}),class$__$1))){
...
var G__19088 = attrs;
var G__19088__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(attrs))?cljs.core.update_in.call(null,G__19088,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$):G__19088);
return G__19088__$1;
});
/**
...
var len__17919__auto___19091 = arguments.length;
var i__17920__auto___19092 = (0);
while(true){
if((i__17920__auto___19092 < len__17919__auto___19091)){
args__17926__auto__.push((arguments[i__17920__auto___19092]));

var G__19093 = (i__17920__auto___19092 + (1));
i__17920__auto___19092 = G__19093;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__17927__auto__);
});
...
var G__19090 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
var G__19090__$1 = ((!(cljs.core.empty_QMARK_.call(null,classes__$1)))?cljs.core.assoc.call(null,G__19090,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1):G__19090);
return G__19090__$1;
});

sablono.normalize.merge_with_class.cljs$lang$maxFixedArity = (0);

sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq19089){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19089));
});
/**
...
var vec__19097 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__19097,(0),null);
var names = cljs.core.nth.call(null,vec__19097,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__19097,tag_name,names){
return (function (p1__19094_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__19094_SHARP_));
});})(matches,vec__19097,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__19097,tag_name,names){
return (function (p1__19095_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__19095_SHARP_));
});})(matches,vec__19097,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__19098){
var vec__19101 = p__19098;
var tag = cljs.core.nth.call(null,vec__19101,(0),null);
var content = cljs.core.nthnext.call(null,vec__19101,(1));
...
var vec__19102 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__19102,(0),null);
var id = cljs.core.nth.call(null,vec__19102,(1),null);
var class$ = cljs.core.nth.call(null,vec__19102,(2),null);
